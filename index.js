...
console.log('Nome:', usuario.getNome()); // Saída: Nome: Diva
console.log('Contato:', usuario.getContato()); // Saída: Contato: donadiva@email.com
console.log('Tipo:', usuario.getTipo()); // Saída: Tipo: Receptor
console.log('Região:', usuario.getRegiao()); // Saída: Região: Zona Sul
...
console.log('Novo:', usuario.getNome()); // Saída: Novo Nome: Tia Danuzia
usuario.setContato('danuzia@email.com');
console.log('Novo Contato:', usuario.getContato()); // Saída: Novo Contato: danuzua@email.com

usuario.setTipo('Doador');
console.log('Novo Tipo:', usuario.getTipo()); // Saída: Novo Tipo: Doador

usuario.setRegiao('Zona Leste');
console.log('Nova Região:', usuario.getRegiao()); // Saída: Nova Região: Zona Leste
